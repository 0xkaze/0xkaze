<!-- ════════════════════════ BANNER ════════════════════════ -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:4A9EFF,100:9B72FF&height=180&section=header" alt="" />
...
const guilherme = {
  ...
  building: "scalable products with React, FastAPI & GCP",
  exploring: ["LLMs & RAG", "Graph databases (Neo4j)", "Distributed systems"],
  motto: "Ship fast, without compromising quality.",
};
```

- 🧠 Building **AI, Web3 & automation** platforms end-to-end
...
| Degree | Institution |
| :--- | :--- |
| 🎓 **B.Sc. Information Management** | Universidade Federal do Paraná (UFPR) |
| 🧠 **B.Sc. Computer Engineering** | Faculdade Descomplica |
